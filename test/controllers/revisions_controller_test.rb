...
class RevisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create revision" do
    assert_difference('Revision.count') do
      post revisions_url, params: { revision: { article_id: @revision.article_id, content: @revision.content, title: @revision.title, user_id: @revision.user_id } }
    end
  ...
  test "should update revision" do
    patch revision_url(@revision), params: { revision: { article_id: @revision.article_id, content: @revision.content, title: @revision.title, user_id: @revision.user_id } }
